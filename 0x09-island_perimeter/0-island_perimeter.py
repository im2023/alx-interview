#!/usr/bin/python3
"""
Defining island_perimeter function finding the perimeter
of the island in body of water.
"""
...
def boundary(grid, i, j):
    """Finding cells with 4, 3, 2 or 1 exposed boundary/adding them to
       appropriate set.
       Args:
           grid (list): 2d list
           i (int): row number.
...
def island_perimeter(grid):
    """
    Calculating/returning perimeter of island in the grid
