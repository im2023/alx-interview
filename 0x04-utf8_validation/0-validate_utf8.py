#!/usr/bin/python3
"""
Defining thevalidUTF8(data) function that validates 
whether string of ints represents valid UTF-8 encoding.
"""
...
def validUTF8(data):
    """
    Taking the list of integers, returns true if the list is
    true UTF-8 encoding, else returns false.
    Args:
        data : List of integers representing UTF-8 encoding
    Return:
        bool : True or False.
    """
